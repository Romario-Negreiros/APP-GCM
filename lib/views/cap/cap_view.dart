...
class CapView extends StatelessWidget {
  const CapView({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: Estilos.appbar(context, 'CAP'),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'CAP (Curso de Aperfeiçoamento Profissional)',
              ...
              Text(
                'Este módulo será voltado para cursos e instruções, permitindo acompanhar avisos, certidões, datas de treinamentos e emissão de certificados.',
                textAlign: TextAlign.center,
                style: Utils.safeGoogleFont(
                  'Roboto',
                  fontSize: 16,
