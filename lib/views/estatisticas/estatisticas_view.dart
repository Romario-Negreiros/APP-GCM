...
class EstatisticasView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: Estilos.appbar(context, 'Estatística'),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Este módulo apresentará dados sobre a produtividade diária dos plantões, auxiliando no acompanhamento e análise das atividades.',
                textAlign: TextAlign.center,
                style: Utils.safeGoogleFont(
                  'Roboto',
                  fontSize: 16,
